        ...
        <div>
            <article>
                ...
                <div class="container-fluid lockcontent">
                    ...
                    <section>
                        <a href="#CareerDevelopment" data-toggle="collapse">
                            <h3>Career Development</h3>
                        </a>
                        <div id="CareerDevelopment" class="collapse in">
                            <p>
                    ...
                    <section>
                        <a href="#Internships" data-toggle="collapse">
                            <h3>Internships</h3>
                        </a>
                        <div id="Internships" class="collapse in">
                            <p>
                    ...
                    <!--end Internships-->
                    <section>
                        <a href="#PeerMentors" data-toggle="collapse">
                            <h3>Peer Mentors</h3>
                        </a>
                        <div id="PeerMentors" class="collapse in">
                            <p>
                    ...
                    <!--end Peer Mentors-->
                    <section>
                        <a href="#AOATCurriculum" data-toggle="collapse">
                            <h3>AOAT Currculum</h3>
                        </a>
                        <div id="AOATCurriculum" class="collapse in">
                            <section>
                            ...
                            <section>
                                ...
                                <h5>Team Leader: Laura Neustaedter</h5>
                                <p>
                                ...
                                <ul>
                                    ...
                                    <li>English
                                        <ul>
                                            ...
                                            <li>Contemportary Composition</li>
                                        </ul>
                                    </li>
                                </ul>
                            </section>
                            ...
                            <section>
                                ...
                                <h5>Team Leader: Wesley DeGracia</h5>
                                <p>
